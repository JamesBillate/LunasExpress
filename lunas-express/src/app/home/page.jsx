...
export default function Home() {
  ...
  return (
    <div className="bg-[#ededed] min-h-screen">
      ...
      {/* Product Grid */}
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 mx-4 md:mx-20 pt-10 pb-20 px-4">
        {listings ? (
          listings.map((item) => (
            <ShopCard
              key={item.id}
